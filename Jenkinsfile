    ...
    stage('Run Tests') {
        script {
                    ...
                    sh 'curl --header "Content-Type: application/json" \
                        --request POST \
                        --data '{"arguments": "-- --params.suite_name=\"All\" --params.testrun_id=308 --params.token=\"7aed6645-857f-4e0e-b2af-5cea44a001681570005255102\" --specs=\"tests/scenarios/uiTests/smoke/spec1.js\""}' \
